...
class MainUi(QtWidgets.QMainWindow):
	...
	def init_ui(self):
		...
		self.right_widget = RightUi() # 创建右侧部件
		...
		self.left_label_1 = QtWidgets.QPushButton("任务设置")

		self.left_label_1.setObjectName('left_label')

		self.left_label_2 = QtWidgets.QPushButton("订单管理")

		self.left_label_2.setObjectName('left_label')

		self.left_label_3 = QtWidgets.QPushButton("软件设置")

		self.left_label_3.setObjectName('left_label')


		self.left_button_1 = QtWidgets.QPushButton(qtawesome.icon('fa.book',color='#49CACF'),"任务")

		self.left_button_1.setObjectName('left_button')

		self.left_button_2 = QtWidgets.QPushButton(qtawesome.icon('fa.sellsy',color='#49CACF'),"代理")

		self.left_button_2.setObjectName('left_button')

		self.left_button_3 = QtWidgets.QPushButton(qtawesome.icon('fa.reply',color='#49CACF'),"账号")

		self.left_button_3.setObjectName('left_button')

		self.left_button_4 = QtWidgets.QPushButton(qtawesome.icon('fa.gear',color='#49CACF'),"礼品卡")

		self.left_button_4.setObjectName('left_button')

		self.left_button_5 = QtWidgets.QPushButton(qtawesome.icon('fa.download',color='#49CACF'),"地址")

		self.left_button_5.setObjectName('left_button')

		self.left_button_6 = QtWidgets.QPushButton(qtawesome.icon('fa.heart',color='#49CACF'),"订单")

		self.left_button_6.setObjectName('left_button')

		self.left_button_7 = QtWidgets.QPushButton(qtawesome.icon('fa.credit-card',color='white'),"订单")

		self.left_button_7.setObjectName('left_button')

		self.left_button_8 = QtWidgets.QPushButton(qtawesome.icon('fa.star',color='white'),"代理")

		self.left_button_8.setObjectName('left_button')

		self.left_button_9 = QtWidgets.QPushButton(qtawesome.icon('fa.tags',color='white'),"地址")
		...
		self.left_layout.addWidget(self.left_close, 0, 2,3,3)

		self.left_layout.addWidget(self.left_visit, 0, 1, 1, 1)

		self.left_layout.addWidget(self.left_label_1,1,0,3,6)

		self.left_layout.addWidget(self.left_button_1, 4, 0,3,6)

		self.left_layout.addWidget(self.left_button_2, 5, 0,3,6)

		self.left_layout.addWidget(self.left_button_3, 6, 0,3,6)

		self.left_layout.addWidget(self.left_label_2, 5, 0,3,6)

		self.left_layout.addWidget(self.left_button_4, 7, 0,3,6)

		self.left_layout.addWidget(self.left_button_5, 8, 0,3,6)

		self.left_layout.addWidget(self.left_button_6, 9, 0,3,6)
		...
		self.right_bar_widget_search_input.setPlaceholderText("输入订单进行搜索")
		...
		self.recommend_button_1.setText("XXX") # 设置按钮文本
		...
		self.recommend_button_2.setText("XXX")
		...
		self.recommend_button_3.setText("XXX")
		...
		self.recommend_button_4.setText("XXX")
		...
		self.recommend_button_5.setText("XXX")
		...
		self.right_newsong_lable = QtWidgets.QLabel("最新鞋款")

		self.right_newsong_lable.setObjectName('right_lable')


		self.right_playlist_lable = QtWidgets.QLabel("热门鞋款")
		...
		self.newsong_button_1 = QtWidgets.QPushButton("YYY")

		self.newsong_button_2 = QtWidgets.QPushButton("YYY")

		self.newsong_button_3 = QtWidgets.QPushButton("YYY")

		self.newsong_button_4 = QtWidgets.QPushButton("YYY")

		self.newsong_button_5 = QtWidgets.QPushButton("YYY")

		self.newsong_button_6 = QtWidgets.QPushButton("YYY")
		...
		self.playlist_button_1.setText("ZZZZ")
		...
		self.playlist_button_2.setText("ZZZZ")
		...
		self.playlist_button_3.setText("ZZZZ")
		...
		self.playlist_button_4.setText("ZZZZ")
		...
		maximizeAction = QtWidgets.QAction("最大化", self,
		...
		self.trayIcon.setIcon(QtGui.QIcon("1.jpg"))
		self.trayIcon.setContextMenu(self.trayIconMenu)
		self.trayIcon.show()

	def setQss(self):

		self.left_close.setFixedSize(155,155) # 设置关闭按钮的大小
		self.left_visit.setFixedSize(15, 15) # 设置按钮大小

		self.left_mini.setFixedSize(15, 15) # 设置最小化按钮大小
 #background:#F76677
		self.right_widget.closeButton.setStyleSheet('''QPushButton{background:#F76677;border-radius:5px;}QPushButton:hover{background:red;}''')

		self.left_close.setStyleSheet('''QPushButton{border-image : url(1.jpg)}''')

		self.right_widget.minButton.setStyleSheet('''QPushButton{background:#F7D674;border-radius:5px;}QPushButton:hover{background:yellow;}''')

		self.right_widget.settingButton.setStyleSheet('''QPushButton{background:#6DDF6D;border-radius:5px;}QPushButton:hover{background:green;}''')
...
# background:rgba(0,0,0,50%);
        ...
        QPushButton#left_button:hover{border-left:4px solid #249ECB;font-weight:700;background:#0D0B22;color : white}''')
